...
@section('title', 'Employee Form Field')
@section('content')
 ...
 <div class="card-body">
   <div class="container">
       <div class="row" style="border-bottom:1px solid lightgrey;margin-bottom:20px">
           <div class='col-md-6'>
               <p style="font-weight:bold">Employee Form Field List</p>                           
           </div>
           <div class="col-md-6">
    ...
    <table id="datatablesSimple" class="table table-bordered">
        ...
        <tbody>
            @foreach($data as $key => $item)
             @if($item != 'image' && $item != 'id' && $item != 'user_id' && $item != 'created_at' && $item != 'updated_at')
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{url('delete-employee-column', [$col1])}}" class="btn btn-danger btn-sm">Delete</a>
                    @endif
                </td>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{url('update-employee-column')}}" method="post">
                            <div class="row">
                                @csrf
                                <input type="hidden" name="table" value="employee">
                                    <div class="col-md-4 mb-1 text-md-right">
                                    ...
                                    <div class="col-md-8 mb-1">
                                        ...
                                        <input type="hidden" id="old_column_name" name="old_column_name" class="form-control" placeholder="Column Name">
                                    </div>                
                                </div>       
                                <div class="col-md-12 text-right mt-2">
                                    <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
