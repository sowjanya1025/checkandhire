...
@section('title', 'Register Form Field')
@section('content')
 ...
 <div class="card-body">
   <div class="container">
       <div class="row" style="border-bottom:1px solid lightgrey;margin-bottom:20px">
           <div class='col-md-6'>
               <p style="font-weight:bold">Register Form Field List</p>                           
           </div>
           <div class="col-md-6">
    ...
    <table id="datatablesSimple" class="table table-bordered">
        ...
        <tbody>
            @foreach($data as $key => $item)
             @if($item != 'image' && $item != 'id' && $item != 'role' && $item != 'is_verified' && $item != 'status' && $item != 'is_active' && $item != 'verification' && $item != 'otp' && $item != 'forgot_token' && $item != 'is_active' && $item != 'email_verified_at' && $item != 'remember_token' && $item != 'contribute' && $item != 'consume' && $item != 'created_at' && $item != 'updated_at')
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{url('delete-register-column', [$col1])}}" class="btn btn-danger btn-sm">Delete</a>
                    @endif
                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{url('create-register-column')}}" method="post">
                            <div class="row">
                                @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{url('update-register-column')}}" method="post">
                            <div class="row">
                                @csrf
                                <input type="hidden" name="table" value="feedback">
                                    <div class="col-md-4 mb-1 text-md-right">
