...
@section('title', 'Add deal of the day list')
...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add deal of the day list</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">              
              <li class="breadcrumb-item"><a href="{{route('day.index')}}">Deal of the day list</a></li>
              ...
              <div class="card-body">                                
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <form action="{{route('day.create')}}" method="post" id="product_add_form" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="row my-2">
                                ...
                                <input type="text" name="day_special_price" class="col-md-8 text-left form-control" id="" placeholder="Special Price" value="{{old('day_special_price')}}">                                
                                @error('day_special_price')
