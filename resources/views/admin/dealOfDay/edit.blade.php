...
@section('title', 'Edit deal of the day list')
...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit deal of the day list</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">              
              <li class="breadcrumb-item"><a href="{{route('day.index')}}">Edit deal of the day list</a></li>
                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <input type="hidden" name="id" value="{{$product->id}}">
                            ...
                            <div class="row my-2">
                                ...
                                <input type="text" name="day_special_price" class="col-md-8 text-left form-control" id="" placeholder="Special Price" value="{{old('day_special_price') ?? $product->day_special_price}}">
