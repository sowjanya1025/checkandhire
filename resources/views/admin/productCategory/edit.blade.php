                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <input type="hidden" name="id" value="{{$data->id}}">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <img id="preview" src="@if(empty($data->image)){{asset('images/dummy.jpg')}}@else {{$data->image}}@endif" alt="" width="150px" height="150px"><br>
                                </div>                                
                            ...
                            <div class="row my-2">
                                ...
                                <input type="text" name="name" class="col-md-8 text-left form-control" id="" placeholder="Category Name" value="{{$data->name}}">
                                @error('name')
