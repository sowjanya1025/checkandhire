                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <input name="id" type="hidden" value="{{$feed->id}}">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <img id="preview" src="@if(empty($feed->images)){{asset('images/dummy.jpg')}}@else {{$feed->images}}@endif" alt="" width="150px" height="150px"><br>
                                </div>                                
                            ...
                            <div class="row my-2">
                                ...
                                <input type="text" name="message" class="col-md-8 text-left form-control" id="" placeholder="Message" value="{{old('message') ?? $feed->message}}">
                                @error('message')
                                    <div class="text-red col-md-8 offset-md-4 error_message">{{ $message }}</div>
                                @enderror
                            </div>     
                            <div class="row my-2">
                                ...
                                <input type="text" name="location" class="col-md-8 text-left form-control" id="" placeholder="Location" value="{{old('location') ?? $feed->location}}">
                                @error('location')
                                    <div class="text-red col-md-8 offset-md-4 error_message">{{ $message }}</div>
                                @enderror
                            </div>                                                                                                                                                                                                                                                                                                          
